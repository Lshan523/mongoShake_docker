...
echo '# if you have any problem, please visit https://github.com/alibaba/MongoShake/wiki/FAQ
...
# connect source mongodb, set username and password if enable authority. Please note: password should not contain @.
...
########################################### mongo_urls ##############################################################
#mongo_urls = mongodb://root:root@192.168.18.176:27018,192.168.18.176:27019,192.168.18.176:27020
...
special.source.db.flag = '${special_source_db_flag}' ' > /mongo-shake-v2.6.5/collector.conf
